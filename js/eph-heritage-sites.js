...
let html = '';
  ...
  let tautanTambah = `<p><a href="${wikiBaseUrl}" target="_blank" class="sunting-linktambah" title="Tambahkan data di Wikidata" style="font-style: italic;">Lengkapi/perbarui data di Wikidata!</a></p>`;
  html += tautanTambah;
